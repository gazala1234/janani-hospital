            ...
            <div class="col-12 col-lg-9">
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="searchModalLabel">Posting in/ Ask For Suggestion</h5>
                ...
                <div class="card post-card">
                    ...
                    <div class="post-actions">
                        <div>
                            <span class="icon"><i class="bi bi-hand-thumbs-up"></i> 2</span>
                            <span class="icon"><i class="bi bi-chat-dots"></i> 0</span>
